...
<div style="padding:10px">
	...
	<?php
		...
		while($ROWS = mysqli_fetch_array($results))  
		{
			...
			$binalot_quantity = $ROWS['wh_quantity'];
...
function printDR(controlno)
{
	...
	$.post("./Modules/Binalot_Management/includes/printable_dr.php", { control_no: controlno },
	function(data) {		
...
function requestReopenYes(controlno)
{
	...
	if(delivery_date == 0)
	{
		...
		$.post("./Modules/Binalot_Management/actions/actions.php", { mode: mode, control_no: controlno, recipient: recipient },
		function(data) {		
	...
	else if(delivery_date == 1)
	{
		...
		var recipient = $('#recipient').val();
		$.post("./Modules/Binalot_Management/actions/actions.php", { mode: mode, year: year, month: month, day: day, control_no: controlno, recipient: recipient },
		function(data) {		
			$('#setintransitresults').html(data);
		});	
	}
...
function setInTransit(controlno)
{
	...
	if(delivery_date == 0)
	{
		...
		setTimeout(function()
		{
			$.post("./Modules/Binalot_Management/actions/actions.php", { mode: mode, control_no: controlno },
			function(data) {		
				$('#setintransitresults').html(data);
				rms_reloaderOff();
			});
...
function logisticInfo(controlno)
{
	...
	$.post("./Modules/Binalot_Management/apps/logistic_info.php", { control_no: controlno },
	function(data) {		
