...
if(isset($_SESSION['BINALOT_ITEM_LOCATION']) && $_SESSION['BINALOT_ITEM_LOCATION'] != '')
{
...
<div class="smnav-header">
	...
	<div class="search-shell">
		<select id="location" class="form-control form-control-sm" disabled>
...
$(function()
{
	$('#location').change(function()
	{
		...
		rms_reloaderOn();
		$.post("./Modules/Binalot_Management/includes/inventory_data.php", { limit: limit, search: search, location: location },
		function(data) {
			$('#smnavdata').html(data);
			rms_reloaderOff();
		});
