...
<div class="smnav-header">
	...
	<span class="date-shell">
		...
		<input type="hidden" id="recipient" style="width:490px;" class="form-control form-control-sm" value="BINALOT" disabled>
		...
		<span style="margin-left:30px; margin-top:6px; font-size:12px">
			To view all orders organized by 
				<span style="color:red; cursor:pointer" onclick="Check_Permissions('p_view',openMenuGranted,'binalot_branch_order_receiving','Branch Order Receiving')"> Item Name</span> 
				or 
				<span style="color:red; cursor:pointer" onclick="Check_Permissions('p_view',openMenuGranted,'binalot_branch_order_receiving2','Branch Order Receiving')"> Item Name with Branch</span> 
		</span>
...
function filterviadate()
{
	...
	$.post("./Modules/Binalot_Management/apps/date_filtering_form.php", { limit: limit, recipient: recipient, ord: ord },
	function(data) {		
...
function getRecipientData()
{
	...
	$.post("./Modules/Binalot_Management/includes/branch_order_receiving_data.php", { limit: limit, recipient: recipient, ord: ord },
	function(data) {		
		$('#smnavdata').html(data);
		rms_reloaderOff();
	});
...
$(function()
{
	...
	$('#search').keyup(function()
	{
		...
		$.post("./Modules/Binalot_Management/includes/branch_order_receiving_data.php", { limit: limit, search: search, recipient: recipient, ord: ord },
		function(data) {
			$('#smnavdata').html(data);
		});
