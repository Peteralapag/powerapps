...
';
	$page = '';
	$sqlPageCnt = "SELECT * FROM binalot_branch_order WHERE control_no='$control_no' AND cancelled=0 AND quantity <> 0";
...
';
		$sqlQuery = "SELECT * FROM binalot_branch_order WHERE control_no='$control_no' AND cancelled=0 AND quantity <> 0 LIMIT $startFrom, $itemsPerDiv";
