...
<div class="smnav-header">
	...
	<span style="margin-left:30px; margin-top:6px; font-size:12px">
		To access the reception area for binalot production, please <span style="color:red; cursor:pointer" onclick="Check_Permissions('p_view',openMenuGranted,'binalot_receiving','Binalot Receiving')">click</span> here.
	</span>
...
function ReceiveForm(params)
{
	...
	$.post("./Modules/Binalot_Management/apps/receiving_form.php", { params: params },
	function(data) {		
...
$(function()
{
	$('#search').keyup(function()
	{
		...
		$.post("./Modules/Binalot_Management/includes/receiving_data.php", { limit: limit, search: search },
		function(data) {
			$('#smnavdata').html(data);
		});
...
{
	var limit = $('#limit').val();
	$.post("./Modules/Binalot_Management/includes/receiving_data.php", { limit: limit },
	function(data) {
		$('#smnavdata').html(data);
	});
}
