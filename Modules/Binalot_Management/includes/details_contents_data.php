...
<?php
	$sqlQuery = "SELECT * FROM binalot_receiving_details WHERE receiving_id='$receiving_id' AND supplier_id='$supplier_id'";
...
function closeReceivingYes(params)
{
	...
	setTimeout(function()
	{
		$.post("./Modules/Binalot_Management/actions/close_receiving.php", { rid: params },
		function(data) {		
...
{
	$.post("./Modules/Binalot_Management/apps/details_form.php", { mode: mode, rid: receiving_id, sid: supplier_id, rowid: rowid },
	function(data) {		
