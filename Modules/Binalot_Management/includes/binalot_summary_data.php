...
$previousDate = date('Y-m-d', strtotime($transdate. ' -1 day'));
...
if ($pcountChecker == 1) {
    ...
    echo '<div class="alert alert-success alert-sm" role="alert">The "Post This Summary" button will not appear if there is no previous PCount.</div>';
...
function postSummary() {
    ...
    if (dataToSend.length > 0) {
        ...
        $.post("./Modules/Binalot_Management/actions/actions.php", { mode: mode, transdate: transdate, data: JSON.stringify(dataToSend) },
            function(data) {        
                $('#smnavdata').html(data);
                rms_reloaderOff();
                viewSummary();
