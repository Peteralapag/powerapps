...
<div class="flex-container">
  <div class="box">
    <table class="table table-striped table-sm">
        ...
        <tbody>
            <?php
            $stmt = $db->prepare("SELECT * FROM binalot_branch_order WHERE control_no = ? AND branch = ?");
...
function voidthis(controlno){
	...
	setTimeout(function()
	{
		$.post("./Modules/Binalot_Management/actions/actions.php", { mode: mode, controlno: controlno, module: module, reasons: reasons },
		function(data) {		
			$('#results').html(data);
			rms_reloaderOff();
		});
