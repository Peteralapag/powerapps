...
$created_by = $_SESSION['binalot_appnameuser'];
...
if($_POST['mode'] == 'new')
{
	...
	$queryInsert = "INSERT INTO binalot_warehouse_transfer ($column)";
...
if($_POST['mode'] == 'update')
{
	...
	";
	$queryDataUpdate = "UPDATE binalot_warehouse_transfer SET $update WHERE id='$rowid'";
