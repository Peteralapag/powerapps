...
<div class="settings-wrapper">
	<div class="settings-box" style="width:100%">
		<div class="box-title">BINALOT NAVIGATION BAR</div>
...
$(function()
{
	$.post("./Modules/Binalot_Management/binalot_settings/main_navigation.php", {  },
	function(data) {		
		$('#mainnavbox').html(data);
	});
	$.post("./Modules/Binalot_Management/binalot_settings/lead_time.php", {  },
	function(data) {		
