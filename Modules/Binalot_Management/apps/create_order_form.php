...
$sqlQuery = "SELECT * FROM binalot_order_request WHERE request_id='$rowid'";
...
{
	$editid = $_POST['editid'];
	$sqlQueryEdit = "SELECT * FROM binalot_branch_order WHERE id='$editid'";
	...
	$sqlQueryEditRemarks = "SELECT * FROM binalot_branch_order_remarks WHERE branch='$branch' AND control_no='$mrs_no'";
...
//	var remarks = $('#remarks').val();
	...
	setTimeout(function()
	{
		$.post("./Modules/Binalot_Management/actions/create_order_process.php",
		{
			mode: mode,
			editid: editid,
			rowid: rowid,
...
function saveRemarks(params)
{
	...
	setTimeout(function()
	{
		$.post("./Modules/Binalot_Management/actions/save_order_remarks.php",
		{
			mode: mode,
			rowid: rowid,
			branch: branch,
