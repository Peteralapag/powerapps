...
<div class="form-wrapper">	
	<table style="width: 100%" class="table">
		...
		<?php
			...
			$QUERY = "SELECT * FROM binalot_branch_order WHERE item_code='$itemcode' AND delivery_date='$transdate' AND branch_received_status='1' AND control_no IN (SELECT control_no FROM binalot_order_request WHERE logistics = '1')";
