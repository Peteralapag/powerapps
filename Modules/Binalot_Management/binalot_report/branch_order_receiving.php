...
$selectedcluster = @$_SESSION['BINALOT_SUMMARY_SELECTEDCLUSTER'];
...
function searchItem() {
	...
	$.post("./Modules/Binalot_Management/binalot_report/search_processor.php", {
		...
		if (data.branch_page) {
			loadCount++;
			$("#iwd").load("./Modules/Binalot_Management/binalot_report/" + data.branch_page, {
				selectedbranch: branchInput,
				dateFrom: dateFrom,
				dateTo: dateTo
			}, checkIfAllLoaded);
		...
		if (data.cluster_page) {
			loadCount++;
			$("#iwd").load("./Modules/Binalot_Management/binalot_report/" + data.cluster_page, {
		...
		if (data.allbranch_page) {
			loadCount++;
			$("#iwd").load("./Modules/Binalot_Management/binalot_report/" + data.allbranch_page, {
