...
?>	
		...
		<?php
			$total = 0;
			$positiveTotal = 0;			
			$sqlQueryIR = "SELECT * FROM binalot_branch_order WHERE control_no IN ( SELECT control_no FROM binalot_order_request WHERE status = 'Closed' ) AND DATE_FORMAT(delivery_date, '%Y-%m') = '$ddate' AND item_code='$itemcode' AND branch='$branch'";
