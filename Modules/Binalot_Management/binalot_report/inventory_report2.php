...
//$selecteddate = @$_SESSION['BINALOT_SUMMARY_SELECTEDDATED'];
...
function searchItem() {
	...
	$.post("./Modules/Binalot_Management/binalot_report/" + page, { selectedcluster: selectedcluster, dateFrom: dateFrom, dateTo: dateTo},
	function(data) {		
		$('#iwd').html(data);
		rms_reloaderOff();
	});
