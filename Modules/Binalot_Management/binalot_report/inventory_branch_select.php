...
function setBranch(branch)
{
	...
	$.post("./Modules/Binalot_Management/actions/actions.php", { mode: mode, branch: branch },
	function(data) {		
	//	$('#widres').html(data);	
	});
}
$(function()
{
	...
	$('#branchsearch').keyup(function()
	{
		...
		$.post("./Modules/Binalot_Management/binalot_report/inventory_branch_search.php", { search: search },
		function(data) {		
