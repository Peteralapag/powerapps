...
function otherDetails(table,title,itemcode,transdate){
	...
	$.post("./Modules/Binalot_Management/apps/inventory_others_form.php", { itemcode: itemcode, transdate: transdate, table: table },
	function(data) {		
...
function timeOutDetails(itemcode,transdate){
	...
	$.post("./Modules/Binalot_Management/apps/inventory_out_form.php", { itemcode: itemcode, transdate: transdate },
	function(data) {		
		$('#formmodal_page').html(data);
		$('#formmodal').show();
	});
...
function timeInDetails(itemcode,transdate){
	...
	$.post("./Modules/Binalot_Management/apps/inventory_in_form.php", { itemcode: itemcode, transdate: transdate },
	function(data) {		
		$('#formmodal_page').html(data);
		$('#formmodal').show();
	});
