...
function removedColumn()
{
	...
	$.post("./Modules/Binalot_Management/reporting/binalot_report_data.php", { limit: limit, columns: chkcolumns },
	function(data) {		
		$('#tableData').html(data);
	});  
}
...
{
	var limit = $('#limit').val();
	$.post("./Modules/Binalot_Management/reporting/binalot_report_data.php", { limit: limit, columns: columns },
	function(data) {
		$('#tableData').html(data);
	});
}
