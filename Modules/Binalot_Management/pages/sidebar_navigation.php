...
if(isset($_SESSION['binalot_userlevel']))
{
...
<?php
$sqlMenu = "SELECT * FROM binalot_navigation WHERE active=1 ORDER BY ordering ASC";
...
function fdsSettings()
{
	...
	if(user_level => 80)
	{
		$.post("./Modules/Binalot_Management/pages/binalot_settings.php", { },
		function(data) {
			$('#contents').html(data);
		});
	} else {
...
{
	$.post("./Modules/Binalot_Management/pages/menu_pages.php", { page: page },
	function(data) {
		$('#contents').html(data);
	});
}
...
{
	$.post("./Modules/Binalot_Management/actions/close_applications.php", { },
	function(data) {
		$('#contents').html(data);
	});
}
