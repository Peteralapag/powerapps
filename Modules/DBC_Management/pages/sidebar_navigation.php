...
if(isset($_SESSION['dbc_userlevel']))
{
...
<?php
$sqlMenu = "SELECT * FROM dbc_navigation WHERE active=1 ORDER BY ordering ASC";
...
function fdsSettings()
{
	...
	if(user_level => 80)
	{
		$.post("./Modules/DBC_Management/pages/dbc_settings.php", { },
		function(data) {
			$('#contents').html(data);
		});
	} else {
...
{
	$.post("./Modules/DBC_Management/pages/menu_pages.php", { page: page },
	function(data) {
		$('#contents').html(data);
	});
}
...
{
	$.post("./Modules/DBC_Management/actions/close_applications.php", { },
	function(data) {
		$('#contents').html(data);
	});
}
