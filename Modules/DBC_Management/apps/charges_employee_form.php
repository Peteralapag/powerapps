...
<div class="form-wrapper">    
 ...
 //   				echo 'ITEM NAME: '.$item.'	QUANTITY: '.$qty.'	UNIT PRICE: '.$unitprice.'	TOTAL: '.$total;
        ...
        $stmt = $db->prepare("SELECT * FROM dbc_charges_extension_record WHERE chargecodeno = ?");
...
function addChargesNoneBaker(){
	...
	$.post("./Modules/DBC_Management/apps/dbc_add_charges_none_baker.php", { chargecodeno:chargecodeno, itemname:itemname, itemcode:itemcode, category:category, original_qty:original_qty, original_unitprice:original_unitprice, original_total:original_total },
	function(data) {		
