...
function removedColumn()
{
	...
	$.post("./Modules/DBC_Management/reporting/dbc_report_data.php", { limit: limit, columns: chkcolumns },
	function(data) {		
		$('#tableData').html(data);
	});  
}
...
{
	var limit = $('#limit').val();
	$.post("./Modules/DBC_Management/reporting/dbc_report_data.php", { limit: limit, columns: columns },
	function(data) {
		$('#tableData').html(data);
	});
}
