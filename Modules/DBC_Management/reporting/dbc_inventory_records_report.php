...
$_SESSION['DBC_TABLE'] = $_POST['table'];
...
function loadSubInvStats()
{
	...
	var year = $('#year').val();
	rms_reloaderOn();
	$.post("./Modules/DBC_Management/reporting/"+ invpage +"_report.php", { limit: limit, months: months, year: year, category: category, invpage: invpage },
	function(data) {		
		$('#tableData').html(data);
		rms_reloaderOff();
	});
