...
if ($mode == 'saveChargesInvolved') {
    ...
    if ($count > 0) {
        ...
        $queryDataInsert = "INSERT INTO dbc_charges (chargecodeno, report_date, category, item_description, item_code, quantity, unit_price, total, created_date, created_by, remarks)
                            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
if($mode == 'addthisemployeechargeextension'){
    ...
    if ($check_stmt) {
        ...
        if ($count == 0) {
            $sql = "INSERT INTO dbc_charges_extension_record (chargecodeno, report_date, idcode, employee_name, employee_type, created_by, category, item_description, item_code, unit_price, remarks) 
                    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
*/	
    ...
    $queryDataInsert = "INSERT INTO dbc_rnd (report_date, branch, category, item_description, item_code, quantity, created_date, created_by, remarks)
                            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
    $stmt = $db->prepare($queryDataInsert);
...
*/	
    ...
    $queryDataInsert = "INSERT INTO dbc_charges (report_date, idcode, employee_name, category, item_description, item_code, quantity, unit_price, total, created_date, created_by, remarks)
                            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    $stmt = $db->prepare($queryDataInsert);
...
*/    
    ...
    $queryDataInsert = "INSERT INTO dbc_badorder (report_date, branch, category, item_description, item_code, quantity, created_date, created_by, remarks)
                            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
    $stmt = $db->prepare($queryDataInsert);
    $stmt->bind_param("sssssdsss", $reportDate, $branch, $category, $itemDescription, $itemCode, $actualYield, $date_time, $user, $remarks);
    if ($stmt->execute()) {
...
*/   
    ...
    $queryDataInsert = "INSERT INTO dbc_complementary (report_date, branch, category, item_description, item_code, quantity, created_date, created_by, remarks)
                            VALUES (?, ?, ?, ?, ?, ?, ?, ? ,?)";
    $stmt = $db->prepare($queryDataInsert);
    $stmt->bind_param("sssssdsss", $reportDate, $branch, $category, $itemDescription, $itemCode, $actualYield, $date_time, $user, $remarks);
    if ($stmt->execute()) {
...
*/	
    ...
    $queryDataInsert = "INSERT INTO dbc_damage (report_date, branch, category, item_description, item_code, quantity, created_date, created_by, remarks)
                            VALUES (?, ?, ?, ?, ?, ?, ?, ? ,?)";
    $stmt = $db->prepare($queryDataInsert);
    $stmt->bind_param("sssssdsss", $reportDate, $branch, $category, $itemDescription, $itemCode, $actualYield, $date_time, $user, $remarks);
    if ($stmt->execute()) {
...
*/
    ...
    $queryDataInsert = "INSERT INTO dbc_return (report_date, branch, category, item_description, item_code, quantity, created_date, created_by, remarks)
                            VALUES (?, ?, ?, ?, ?, ?, ?, ? ,?)";
    $stmt = $db->prepare($queryDataInsert);
    $stmt->bind_param("sssssdsss", $reportDate, $branch, $category, $itemDescription, $itemCode, $actualYield, $date_time, $user, $remarks);
    if ($stmt->execute()) {
