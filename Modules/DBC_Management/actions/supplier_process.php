...
if($mode == 'add')
{
	$query = "SELECT * FROM dbc_supplier WHERE name='$name'";
    ...
    if ( $checkRes->num_rows === 0 ) 
    {
		...
		$queryInsert = "INSERT INTO dbc_supplier ($column)";
...
if($mode == 'edit') {
	...
	$queryDataUpdate = "UPDATE dbc_supplier SET $update WHERE id='$rowid'";
