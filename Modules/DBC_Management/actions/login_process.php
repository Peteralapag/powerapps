...
if($mode=='c10cc6b684e1417e8ffa924de1e58373')
{
    ...
    { 
		...
		if($void == 0)
		{
			$_SESSION['dbc_username'] = $username;
			$_SESSION['dbc_company'] = $company;
			$_SESSION['dbc_appnameuser'] = $employee;
			$_SESSION['dbc_userlevel'] = $user_level;
			$_SESSION['dbc_userrole'] = $user_role;
			$_SESSION['dbc_application'] = $user_app;
			$_SESSION['DBC_TRANSDATE'] = $formattedDate;	
			$cmd = '';
			$cmd .='				
				<script>
					$("#formmodal").hide();
