...
$created_by = $_SESSION['dbc_appnameuser'];
...
if($_POST['mode'] == 'new')
{
	...
	$queryInsert = "INSERT INTO dbc_warehouse_transfer ($column)";
...
if($_POST['mode'] == 'update')
{
	...
	";
	$queryDataUpdate = "UPDATE dbc_warehouse_transfer SET $update WHERE id='$rowid'";
