...
if (isset($_POST['limit']) && $_POST['limit'] !== "") {
    ...
    if ($limit !== false && $limit > 0) {
        ...
        $_SESSION['DBC_SHOW_LIMIT'] = "";
    }
}

// Set order type and recipient filters
if (isset($_POST['ord'])) {
    $_SESSION['DBC_ORD'] = $_POST['ord'];
    $ord = $_POST['ord'];
}
...
if (isset($_POST['recipient'])) {
    ...
    $recipient = $_SESSION['dbc_user_recipient'] ?? '';
}
...
$sqlQuery = "SELECT * FROM dbc_order_request WHERE $qr ORDER BY trans_date DESC $limitClause";
