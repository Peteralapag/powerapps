...
function searchMe(){
	...
	$.post("./Modules/DBC_Management/includes/dbc_branch_order_receiving_data.php", { datefrom: datefrom, dateto: dateto },
	function(data) {
		$('#smnavdata').html(data);
		rms_reloaderOff();
	});
...
function getRecipientData()
{
	...
	var ord = $('#ord').val();
	rms_reloaderOn('Loading...');	
	$.post("./Modules/DBC_Management/includes/dbc_branch_order_receiving_data.php", { limit: limit, recipient: recipient, ord: ord },
	function(data) {		
		$('#smnavdata').html(data);
		rms_reloaderOff();
	});
...
$(function()
{
	...
	$('#search').keyup(function()
	{
		...
		$.post("./Modules/DBC_Management/includes/dbc_branch_order_receiving_data.php", { limit: limit, search: search, recipient: recipient, ord: ord },
		function(data) {
			$('#smnavdata').html(data);
		});
