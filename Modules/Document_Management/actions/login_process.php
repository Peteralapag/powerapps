...
if($mode=='c10cc6b684e1417e8ffa924de1e58373')
{
    ...
    { 
		...
		if($void == 0)
		{
			...
			$_SESSION['md_company'] = $company;
			$_SESSION['md_appnameuser'] = $employee;
			$_SESSION['md_userlevel'] = $user_level;
			$_SESSION['md_userrole'] = $user_role;
			$_SESSION['md_application'] = $user_app;		
			$cmd = '';
			$cmd .='				
				<script>
					$("#formmodal").hide();
