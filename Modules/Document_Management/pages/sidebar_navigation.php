...
if($user_level >= 50)
{
	$q = 'tbl_system_modules WHERE application_id=1002 ORDER BY ordering ASC';
} else {
	$q = "tbl_system_permission WHERE username='$username' AND applications='DOCUMENT MANAGEMENT' ORDER BY ordering ASC";
}
?>
<style>
