...
?>
<style>
.form-wrapper {width:500px;max-height:700px;overflow-y:auto;}
...
<div class="form-wrapper">	
	<table style="width: 100%" class="table">
		<tr>
			<th>Charge Code</th>
			<td>
				<input id="chargecode" type="text" class="form-control form-control-sm" value="<?php echo $chargecodeno?>" disabled>
			</td>
		</tr>
		<tr>
...
function clearthisemployeecharge(){
	...
	$.post("./Modules/DBC_Seasonal_Management/actions/actions.php", { mode: mode, chargecode: chargecode },
    function(data) {
...
function manyinvolvedcharge(){
	...
	$.post("./Modules/DBC_Seasonal_Management/apps/dbc_add_charges_many_involved.php", { },
	function(data) {		
...
function getActualYield(){
	...
	$.post("./Modules/DBC_Seasonal_Management/actions/actions.php",  { mode: mode, batch: batch, itemcode: itemcode },
	function(data) {
		$("#results").html(data);
	});
}
