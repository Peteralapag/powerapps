...
';
		/* ####################################################################################################### */			
		//	$query = "SELECT * FROM dbc_seasonal_picklist WHERE branch='$branch' AND trans_date='$trans_date'";
			$query = "SELECT * FROM dbc_seasonal_picklist WHERE control_no='$control_no'";
