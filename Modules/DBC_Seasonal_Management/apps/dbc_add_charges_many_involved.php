...
function proceedCharges(){
	...
	$.post("./Modules/DBC_Seasonal_Management/actions/actions.php", { mode: 'getStockInHand', itemcode: itemcode }, function(stockData) {
        ...
        $.post("./Modules/DBC_Seasonal_Management/apps/dbc_add_charges_many_involved_form.php", { 
...
function manyinvolve(){
	...
	$.post("./Modules/DBC_Seasonal_Management/apps/dbc_add_charges_form.php", { },
	function(data) {		
		$('#formmodal_page').html(data);
		$('#formmodal').show();
	});
