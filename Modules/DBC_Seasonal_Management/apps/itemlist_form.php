...
{
	$rowid = $_POST['rowid'];
	$QUERY = "SELECT * FROM dbc_seasonal_itemlist WHERE id='$rowid'";
	...
	<table style="width: 100%" class="table">
		...
		<tr>
			...
			<td>
				...
				<input id="recipient" type="text" class="form-control" value="DAVAO BAKING CENTER" disabled>
			</td>
		</tr>
		<tr>
			<th>Item Loc.</th>
			<td>
				...
				<input id="item_location" type="text" class="form-control" value="DAVAO BAKING CENTER" disabled>
			</td>
		</tr>
		<tr>
			<th>Item Code</th>
		...
		<tr>
			...
			<td>
				...
				<!--input id="categories" type="text" class="form-control" value="BREADS" disabled-->
			</td>
		</tr>
		<tr>
...
function deleteItemYes(params)
{
	...
	{
		var limit = $('#limit').val();
		$.post("./Modules/DBC_Seasonal_Management/actions/deleteitem_process.php", { rowid: params,limit: limit },
		function(data) {		
			$('.results').html(data);
			rms_reloaderOff();
		});
...
*/
	...
	setTimeout(function()
	{
		$.post("./Modules/DBC_Seasonal_Management/actions/itemlist_process.php",
		{ 
			mode: mode,
			rowid: rowid,
			active: active, 
