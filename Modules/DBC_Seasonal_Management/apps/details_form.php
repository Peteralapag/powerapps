...
if(isset($_POST['mode']) && $_POST['mode'] != '')
{
	...
	if($_POST['mode'] == 'edit')
	{
		$sqlQuery = "SELECT * FROM dbc_seasonal_receiving_details WHERE receiving_detail_id='$rowid'";
	...
	$mode = "add";
	$sqlQuery = "SELECT * FROM dbc_seasonal_receiving WHERE receiving_id='$receiving_id'";
	$results = mysqli_query($db, $sqlQuery);    
	if ( $results->num_rows > 0 ) 
	{
		while($RECVROW = mysqli_fetch_array($results))  
