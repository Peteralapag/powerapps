...
{
	$rowid = $_POST['rowid'];
	$QUERY = "SELECT * FROM dbc_seasonal_receiving WHERE receiving_id='$rowid'";
	...
	<table style="width: 100%" class="table lamesako">
		<tr>
			...
			<td>
				...
				<input id="supplier" type="text" class="form-control" value="DBC RECEPTION AREA" disabled>
			</td>		
		</tr>
		<tr>
...
*/	
	...
	setTimeout(function()
	{
		$.post("./Modules/DBC_Seasonal_Management/actions/receiving_process.php", 
		{  
			mode: mode,
			rowid: rowid, 
			limit: limit, 
