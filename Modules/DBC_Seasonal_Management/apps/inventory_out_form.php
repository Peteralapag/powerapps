...
<div class="form-wrapper">	
	<table style="width: 100%" class="table">
		...
		<?php
			...
			$QUERY = "SELECT * FROM dbc_seasonal_branch_mrs_transaction WHERE item_code='$itemcode' AND delivery_date='$transdate' AND control_no IN (SELECT control_no FROM dbc_seasonal_order_request_generate_dr WHERE logistics = '1')";
