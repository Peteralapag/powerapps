...
function setInTransit(controlno)
{
	...
	if(delivery_date == 0)
	{
		...
		setTimeout(function()
		{
			$.post("./Modules/DBC_Seasonal_Management/actions/actions.php", { mode: mode, control_no: controlno },
			function(data) {		
				$('#setintransitresults').html(data);
				rms_reloaderOff();
			});
...
function logisticInfo(controlno)
{
	...
	$.post("./Modules/DBC_Seasonal_Management/apps/logistic_info.php", { control_no: controlno },
	function(data) {		
