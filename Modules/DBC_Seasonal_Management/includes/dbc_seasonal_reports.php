...
$report_page = $_SESSION['DBC_SEASONAL_REPORT_PAGE'] ?? '';
$recipient = $_SESSION['DBC_SEASONAL_RECIPIENT_REPORT'] ?? 'WAREHOUSE';
$report_branch = $_SESSION['DBC_SEASONAL_REPORT_BRANCH'] ?? '';
...
function openBranch() {
	...
	$.post("./Modules/DBC_Seasonal_Management/dbc_report/inventory_branch_select.php", {}, function(data) {
...
function loadInventory() {
	...
	$.post(`./Modules/DBC_Seasonal_Management/dbc_report/${page}`, { branch, reports, recipient }, function(data) {
