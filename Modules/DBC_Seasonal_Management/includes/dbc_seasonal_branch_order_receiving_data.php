...
<table style="width: 100%" class="table table-bordered table-striped table-hover">
    ...
    <tbody>
<?php
//   $sqlQuery = "SELECT SUM(quantity) AS qty, item_code, trans_date, item_description, uom FROM dbc_seasonal_branch_order WHERE trans_date BETWEEN '$datefrom' AND '$dateto' GROUP BY item_code, trans_date";
  
	$sqlQuery = "SELECT * FROM dbc_seasonal_itemlist WHERE active = 1 ORDER BY ordered ASC"; 
...
function infothis(itemcode,itemdescription){
	...
	$.post("./Modules/DBC_Seasonal_Management/apps/branch_order_receiving_qty_info_form.php", { itemcode: itemcode, datefrom: datefrom, dateto: dateto },
	function(data) {		
