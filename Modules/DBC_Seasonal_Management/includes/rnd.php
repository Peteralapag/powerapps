...
{
	$('#modaltitle').html("ADD NEW R & D DATA");
	$.post("./Modules/DBC_Seasonal_Management/apps/dbc_add_rnd_form.php", { params: params },
	function(data) {		
...
function getRecipientData()
{
	...
	var ord = $('#ord').val();
	rms_reloaderOn('Loading...');	
	$.post("./Modules/DBC_Seasonal_Management/includes/rnd_data.php", { limit: limit, recipient: recipient, ord: ord },
	function(data) {		
		$('#smnavdata').html(data);
		rms_reloaderOff();
	});
...
$(function()
{
	...
	$('#search').keyup(function()
	{
		...
		$.post("./Modules/DBC_Seasonal_Management/includes/rnd_data.php", { limit: limit, search: search, recipient: recipient, ord: ord },
		function(data) {
			$('#smnavdata').html(data);
		});
