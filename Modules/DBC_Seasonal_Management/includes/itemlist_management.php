...
function selectCategory(category)
{
	...
	if(category != '')
	{
		$.post("./Modules/DBC_Seasonal_Management/includes/itemlist_data.php", { limit: limit, category: category},
		function(data) {		
			$('#smnavdata').html(data);
		});
	} else {
...
$(function()
{
	$('#search').keyup(function()
	{
		...
		$.post("./Modules/DBC_Seasonal_Management/includes/itemlist_data.php", { limit: limit, search: search, category: category },
		function(data) {
			$('#smnavdata').html(data);
		});
...
function load_data()
{
	...
	$.post("./Modules/DBC_Seasonal_Management/includes/itemlist_data.php", { limit: limit },
	function(data) {
		$('#smnavdata').html(data);
		rms_reloaderOff();
	});
