...
$_SESSION['DBC_SEASONAL_TRANSDATE'] = $trans_date;
...
if(isset($_POST['location']) && $_POST['location'] != "")
{
	...
	$_SESSION['DBC_SEASONAL_ITEM_LOCATION'] = $location;
	$q = "WHERE item_location='$location' AND active = 1";
} else {
	$q = "";
}
if(isset($_POST['search']) && $_POST['search'])
{
	...
	$search = $_POST['search'];
	$_SESSION['DBC_SEASONAL_ITEM_LOCATION'] = $location;
	$q = "WHERE item_location='$location' AND item_description LIKE '%$search%' AND active =1";
}
...
<table class="excel-table resizable-table table table-bordered table-striped">
	...
	<tbody>
<?php
	$queryItems = "SELECT * FROM dbc_seasonal_itemlist $q $limit";
