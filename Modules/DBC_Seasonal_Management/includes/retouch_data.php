...
<table style="width: 100%" class="table table-bordered table-striped table-hover">
	...
	<tbody>	
<?PHP
	$sqlQuery = "SELECT * FROM dbc_seasonal_retouch WHERE report_date='$transdate' ORDER BY id DESC";
    	...
    	while($RECVROW = mysqli_fetch_array($results))  
		{
			...
			?>	
				<tr style="vertical-align:middle; background-color:<?php echo $trstyle?>">
					...
					<td style="height: 25px"><?php echo $createddate?></td>
...
{
	var mode = 'voidthisretouch';
	rms_reloaderOn('Loading...');
	$.post("./Modules/DBC_Seasonal_Management/actions/actions.php", { mode: mode, rowid: rowid, itemcode: itemcode },
	function(data) {		
