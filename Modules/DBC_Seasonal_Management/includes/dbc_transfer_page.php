...
{
	$.post("./Modules/DBC_Seasonal_Management/includes/dbc_transfer_form.php", { mode: mode, rowid: rowid },
	function(data) {
...
$(function()
{
	$.post("./Modules/DBC_Seasonal_Management/includes/dbc_stock_list.php", {  },
	function(data) {
		$('#stocklist').html(data);
	});
});	
...
function openFile()
{
	...
	$.post("./Modules/DBC_Seasonal_Management/Includes/dbc_transfer_search.php", {  },
	function(data) {		
