...
<table style="width: 100%" class="table table-bordered table-striped table-hover">
	...
	<tbody>	
<?PHP
	$sqlQuery = "SELECT * FROM dbc_seasonal_charges WHERE report_date='$transdate' ORDER BY id DESC";
...
function viewemployeecharges(chargecodeno,item,qty,unitprice,total,category,itemcode,transdate,status){
	...
	$.post("./Modules/DBC_Seasonal_Management/apps/charges_employee_form.php", { 
