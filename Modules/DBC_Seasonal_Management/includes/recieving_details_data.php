...
{
	$.post("./Modules/DBC_Seasonal_Management/apps/details_form.php", { rid: rid, sid: sid },
	function(data) {		
...
{
	$.post("./Modules/DBC_Seasonal_Management/includes/details_contents_data.php", { rid: rid, sid: sid },
	function(data) {		
