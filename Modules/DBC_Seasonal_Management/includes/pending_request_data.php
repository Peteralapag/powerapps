...
$permit = $function->checkPolicy($_SESSION['dbc_seasonal_username'],'Branch Order Receiving','p_approver',$_SESSION['dbc_seasonal_userlevel'],$db);
?>
<style>
.reopen-wrapper {
	padding-bottom:10px;
...
<div class="reopen-wrapper">
	...
	<table style="width: 100%" class="table table-bordered table-striped table-hover">
		...
		<tbody>
<?php
	$sqlQuery = "SELECT * FROM dbc_seasonal_request WHERE recipient='$recipient' ORDER BY flag ASC";
...
function grandRequest(rowid,control_no)
{
	...
	setTimeout(function()
	{
		$.post("./Modules/DBC_Seasonal_Management/actions/actions.php", { mode: mode, rowid: rowid, control_no: control_no },
		function(data) {		
