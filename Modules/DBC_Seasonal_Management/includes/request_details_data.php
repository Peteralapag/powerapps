...
{
	$.post("./Modules/DBC_Seasonal_Management/apps/create_order_form.php", { rowid: rowid },
	function(data) {		
...
{
	$.post("./Modules/DBC_Seasonal_Management/includes/mrs_contents_data.php", { rowid: rowid },
	function(data) {		
