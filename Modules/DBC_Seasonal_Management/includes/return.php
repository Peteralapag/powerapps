...
<div class="smnav-header">
	...
	?>
	<span>
		<button type="button" class="btn btn-sm btn-success" onclick="addMe()" style="width:130px"><i class="fa fa-plus" aria-hidden="true"></i>
		&nbsp;
		Add Return</button>
	</span>	
	<?php
...
{
	$('#modaltitle').html("ADD NEW RETURN DATA");
	$.post("./Modules/DBC_Seasonal_Management/apps/dbc_add_return_form.php", { params: params },
	function(data) {		
...
function getRecipientData()
{
	...
	var ord = $('#ord').val();
	rms_reloaderOn('Loading...');	
	$.post("./Modules/DBC_Seasonal_Management/includes/return_data.php", { limit: limit, recipient: recipient, ord: ord },
	function(data) {		
		$('#smnavdata').html(data);
		rms_reloaderOff();
	});
...
$(function()
{
	...
	$('#search').keyup(function()
	{
		...
		$.post("./Modules/DBC_Seasonal_Management/includes/return_data.php", { limit: limit, search: search, recipient: recipient, ord: ord },
		function(data) {
			$('#smnavdata').html(data);
		});
