...
<div class="smnav-header">
	...
	?>
	<span>
		<button type="button" class="btn btn-sm btn-success" onclick="addMe()" style="width:140px"><i class="fa fa-plus" aria-hidden="true"></i>
		&nbsp; Add Retouch</button>
	</span>	
	<?php
		}
...
{
	$('#modaltitle').html("ADD NEW RETOUCH DATA");
	$.post("./Modules/DBC_Seasonal_Management/apps/dbc_add_retouch_form.php", { params: params },
	function(data) {		
...
function searchMe(){
	...
	$.post("./Modules/DBC_Seasonal_Management/actions/actions.php", { mode: mode, transdate: transdate },
	function(data) {		
...
function getRecipientData()
{
	...
	var ord = $('#ord').val();
	rms_reloaderOn('Loading...');	
	$.post("./Modules/DBC_Seasonal_Management/includes/retouch_data.php", { limit: limit, recipient: recipient, ord: ord },
	function(data) {		
		$('#smnavdata').html(data);
		rms_reloaderOff();
	});
...
$(function()
{
	...
	$('#search').keyup(function()
	{
		...
		$.post("./Modules/DBC_Seasonal_Management/includes/retouch_data.php", { limit: limit, search: search, recipient: recipient, ord: ord },
		function(data) {
			$('#smnavdata').html(data);
		});
