...
$username = $_SESSION['dbc_seasonal_username'];
$userlevel = $_SESSION['dbc_seasonal_userlevel'];
$permission = 'p_edit';
...
if(isset($_SESSION['DBC_SEASONAL_ITEM_LOCATION']))
{
	$location = $_SESSION['DBC_SEASONAL_ITEM_LOCATION'];
} else {
	$location = "";
}
if(isset($_SESSION['DBC_SEASONAL_TRANSDATE']))
{
...
function load_pcount()
{
	...
	$.post("./Modules/DBC_Seasonal_Management/includes/phycount_data.php", { location: location, trans_date: trans_date, limit: limit },
	function(data) {		
...
$(document).ready(function()
{
	$('#search').keyup(function()
	{
		...
		var location = $('#location').val();
		var trans_date = $("#transdate").val();
		$.post("./Modules/DBC_Seasonal_Management/includes/phycount_data.php", { search: search, location: location, trans_date: trans_date, limit: limit },
		function(data) {		
			$('#phycountdata').html(data);
			rms_reloaderOff();
		});	
