...
$finalize = $function->GetOrderStatusSecondTable($requestid, 'finalize', $db);
	...
	<table style="width: 100%" class="lamesako">
		<thead>
			<tr>
				...
				<th title="UNIT OF MEASURE" style="width:100px">UOM</th>
				<th title="REQUESTED QUANTITY" style="width:100px">REQUESTED QTY.</th>
				<th title="REMAINING BALANCE">REMAINING BALANCE</th>
			</tr>
		</thead>
		<tbody>
<?php
//	$sqlQuery = "SELECT * FROM dbc_seasonal_branch_order WHERE control_no='$control_no'";
	...
	$sqlQuery = "
	    ...
	    WHERE dbo.request_id = '$requestid'
	    ORDER BY dil.ordered ASC
	";
	
	
	$sqlQuery = "SELECT * FROM dbc_seasonal_branch_mrs_transaction WHERE id='$rowid'";
	...
	{ 
		...
		$remainingqty = $actual_quantity - $function->getSumRemainingBalance($control_no,$db);
?>		
			<tr>
