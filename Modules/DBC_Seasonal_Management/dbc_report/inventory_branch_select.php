...
function setBranch(branch)
{
	...
	$.post("./Modules/DBC_Seasonal_Management/actions/actions.php", { mode: mode, branch: branch },
	function(data) {		
	//	$('#widres').html(data);	
	});
}
$(function()
{
	...
	$('#branchsearch').keyup(function()
	{
		...
		$.post("./Modules/DBC_Seasonal_Management/dbc_report/inventory_branch_search.php", { search: search },
		function(data) {		
