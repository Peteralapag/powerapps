...
if ($selectedcluster == '') {
    $sql = "SELECT branch FROM dbc_seasonal_tbl_branch";
} else {
    ...
    if ($results && $results->num_rows > 0) {
        ...
        while ($INVROW = mysqli_fetch_array($results)) {
            ...
            <tr>
                ...
                <td title="<?php echo $itemdescription?>" class="sticky-column sticky-column-3-data"><?php echo htmlspecialchars($itemdescription); ?></td>
