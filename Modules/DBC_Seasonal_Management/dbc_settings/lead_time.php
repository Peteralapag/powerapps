...
<?php
	$queryNav = "SELECT * FROM dbc_seasonal_inventory_leadtime";
...
function UpdateLeadTime(aid)
{
	...
	setTimeout(function()
	{
		$.post("./Modules/DBC_Seasonal_Management/actions/actions.php", { mode: mode, minValue: minValue, maxValue: maxValue },
		function(data) {
