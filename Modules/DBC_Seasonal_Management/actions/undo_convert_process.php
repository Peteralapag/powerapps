...
{
	$rowid = $_POST['rowid'];	
	$delQuery = "SELECT * FROM dbc_seasonal_warehouse_transfer WHERE id='$rowid'";
...
/*			
			$queryDataUpdate = "UPDATE dbc_seasonal_inventory_stock SET stock_in_hand='$total_undo' WHERE item_code='$item_code'";
...
{
	$queryDataDelete = "DELETE FROM dbc_seasonal_warehouse_transfer WHERE id='$rowid'";
