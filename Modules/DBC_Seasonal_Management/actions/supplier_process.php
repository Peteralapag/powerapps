...
if($mode == 'add')
{
	$query = "SELECT * FROM dbc_seasonal_supplier WHERE name='$name'";
    ...
    if ( $checkRes->num_rows === 0 ) 
    {
		...
		$queryInsert = "INSERT INTO dbc_seasonal_supplier ($column)";
...
if($mode == 'edit') {
	...
	$queryDataUpdate = "UPDATE dbc_seasonal_supplier SET $update WHERE id='$rowid'";
