...
<table class="table" style="width:490px">
	...
	<tr>
		<td colspan="2" style="text-align:center">
			<button id="ronanamoytae" type="button" class="btn btn-primary btn-lg w-50"><i class="fa fa-cube" aria-hidden="true"></i>&nbsp;
			Seasonal Register</button>
...
{	
	...
	$.post("../Modules/User_Management/register/DBC_seasonal_register_process.php", { mode:mode },
	function(data) {
...
//	var idcode = $("#idcode").val();
	...
	$.post("../Modules/User_Management/register/DBC_seasonal_register_process.php", { mode: mode,idcode: idcode },
	function(data) {
		$('#resultss').html(data);
...
function register()
{
	...
	setTimeout(function()
	{
		$.post("../Modules/User_Management/register/DBC_seasonal_register_process.php",
		{
			mode: mode,
			idcode: idcode,
			firstname: firstname,
