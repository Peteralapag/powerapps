...
<table class="table" style="width:430px">
	<tr>
		<th>IDCODE:</th>
		<td><input type="text" id="idcode" class="form-control" onBlur="idcodeSearch()" autocomplete="off" placeholder="Your IDCode"></td>
	</tr>
	<tr>
		<th>FIRST NAME:</th>
...
//	$('#pedtroalagay').attr('disabled', true);
	setTimeout(function()
	{
		$.post("../Modules/User_Management/register/register_process.php",
		{
			mode: mode,
			idcode: idcode,
			firstname: firstname,
