...
if($mode=='register')
{
	...
	{
		$sqlInsert = "INSERT INTO tbl_system_user (`company`,`department`,`cluster`,`branch`,`idcode`,`firstname`,`lastname`,`acctname`,`username`,`password`)";
		$sqlInsert .= "VALUES('$company','$department','$cluster','$branch','$idcode','$firstname','$lastname','$acctname','$username','$password')";
		$result=$db->query($sqlInsert);
		if ($result === TRUE)
		{
			applicationManagementMain($idcode,$acctname,$username,$db);
			...
			branchOrderingOrderApproval($idcode,$acctname,$username,$db);
			...
			print_r('
				<script>
					...
					app_alert("Duplicate Warning",dberror,"warning","Ok","","");
					$("#rehistro").attr("disabled", false);
				</script>
			');
		}
	}
...
function applicationManagementMain($idcode,$acctname,$username,$db){
	$sqlInsert = "INSERT INTO tbl_system_permission (`idcode`,`acctname`,`username`,`userlevel`,`applications`,`modules`,`p_view`)";
	$sqlInsert .= "VALUES('$idcode','$acctname','$username','10','Application Management','Main','1')";
	$result=$db->query($sqlInsert);
	if ($result === TRUE){}else{}
}
function branchOrderingMain($idcode,$acctname,$username,$db){
	$sqlInsert = "INSERT INTO tbl_system_permission (`idcode`,`acctname`,`username`,`userlevel`,`applications`,`modules`,`p_view`)";
	$sqlInsert .= "VALUES('$idcode','$acctname','$username','10','Branch Ordering System','Main','1')";
	$result=$db->query($sqlInsert);
	if ($result === TRUE){}else{}
}
function branchOrderingCreateOrder($idcode,$acctname,$username,$db){
	...
	$sqlInsert .= "VALUES('$idcode','$acctname','$username','10','Branch Ordering System','Create Order','1','1','1','1','1','1','1')";
	$result=$db->query($sqlInsert);
	if ($result === TRUE){}else{}
}
function branchOrderingCreateRequest($idcode,$acctname,$username,$db){
	$sqlInsert = "INSERT INTO tbl_system_permission (`idcode`,`acctname`,`username`,`userlevel`,`applications`,`modules`,`p_view`,`p_read`,`p_add`,`p_write`,`p_edit`,`p_delete`,`p_update`)";
	$sqlInsert .= "VALUES('$idcode','$acctname','$username','10','Branch Ordering System','Create Request','1','1','1','1','1','1','1')";
	$result=$db->query($sqlInsert);
	if ($result === TRUE){}else{}
}
function branchOrderingOrderApproval($idcode,$acctname,$username,$db){
	$sqlInsert = "INSERT INTO tbl_system_permission (`idcode`,`acctname`,`username`,`userlevel`,`applications`,`modules`,`p_view`)";
	$sqlInsert .= "VALUES('$idcode','$acctname','$username','10','Branch Ordering System','Order for Approval','1')";
	$result=$db->query($sqlInsert);
	if ($result === TRUE){}else{}
}
function branchOrderingOrderTracking($idcode,$acctname,$username,$db){
	$sqlInsert = "INSERT INTO tbl_system_permission (`idcode`,`acctname`,`username`,`userlevel`,`applications`,`modules`,`p_view`)";
	$sqlInsert .= "VALUES('$idcode','$acctname','$username','10','Branch Ordering System','Order Tracking','1')";
	$result=$db->query($sqlInsert);
	if ($result === TRUE){}else{}
}
function branchOrderingMyOrder($idcode,$acctname,$username,$db){
	$sqlInsert = "INSERT INTO tbl_system_permission (`idcode`,`acctname`,`username`,`userlevel`,`applications`,`modules`,`p_view`)";
	$sqlInsert .= "VALUES('$idcode','$acctname','$username','10','Branch Ordering System','My Orders','1')";
	$result=$db->query($sqlInsert);
	if ($result === TRUE){}else{}
}
