...
<?php
$sqlMenu = "SELECT * FROM dbc_seasonal_branch_navigation WHERE active=1";
...
<div class="btn-group nav-bottom-btn" role="group" aria-label="Ronan Sarbon">
	<?php if($_SESSION['dbc_seasonal_branch_userlevel'] == 50 || $_SESSION['dbc_seasonal_branch_userlevel'] >= 80) { ?>
