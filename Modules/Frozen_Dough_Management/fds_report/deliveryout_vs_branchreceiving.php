...
$_SESSION['FDS_SUMMARY_SELECTEDCLUSTER'] = $_POST['selectedcluster'];
...
<table style="width:100%" class="table table-bordered table-striped">
    <thead>
        <tr class="border-report-title">            
            <th colspan="6" style="text-align:center" class="bg-success sticky-column sticky-column-1">INVENTORY</th>
            <?php
            ...
            */
            ...
            <tr>
                ...
                <?php 
					...
					$totalOutAll = $totalbrout; 
					
					$expectedstocks = ($beginning+$production)-$totalOutAll;
