...
function setBranch(branch)
{
	...
	$.post("./Modules/Frozen_Dough_Management/actions/actions.php", { mode: mode, branch: branch },
	function(data) {		
	//	$('#widres').html(data);	
	});
}
$(function()
{
	...
	$('#branchsearch').keyup(function()
	{
		...
		$.post("./Modules/Frozen_Dough_Management/fds_report/inventory_branch_search.php", { search: search },
		function(data) {		
