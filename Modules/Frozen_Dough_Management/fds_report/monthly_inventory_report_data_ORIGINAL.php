...
?>	
		...
		<?php
			$total=0;
			$sqlQueryIR = "SELECT * FROM fds_inventory_records WHERE item_code='$itemcode' AND month='$month' AND year='$year'";
		...
		?>
			...
			<td style="text-align:right"><?php echo $function->GetUnitPriceRecords($itemcode,$year,$month,$db); ?></td>
