...
<div class="settings-wrapper">
	<div class="settings-box" style="width:100%">
		<div class="box-title">FDS NAVIGATION BAR</div>
...
$(function()
{
	$.post("./Modules/Frozen_Dough_Management/fds_settings/main_navigation.php", {  },
	function(data) {		
		$('#mainnavbox').html(data);
	});
	$.post("./Modules/Frozen_Dough_Management/fds_settings/lead_time.php", {  },
	function(data) {		
