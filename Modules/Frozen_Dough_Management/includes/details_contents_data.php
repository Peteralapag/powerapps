...
<?php
	$sqlQuery = "SELECT * FROM fds_receiving_details WHERE receiving_id='$receiving_id' AND supplier_id='$supplier_id'";
...
function closeReceivingYes(params)
{
	...
	setTimeout(function()
	{
		$.post("./Modules/Frozen_Dough_Management/actions/close_receiving.php", { rid: params },
		function(data) {		
...
{
	$.post("./Modules/Frozen_Dough_Management/apps/details_form.php", { mode: mode, rid: receiving_id, sid: supplier_id, rowid: rowid },
	function(data) {		
