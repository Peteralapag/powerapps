...
function selectCategory(category)
{
	...
	if(category != '')
	{
		$.post("./Modules/Frozen_Dough_Management/includes/itemlist_data.php", { limit: limit, category: category},
		function(data) {		
			$('#smnavdata').html(data);
		});
	} else {
...
function itemsForm(params)
{
	...
	$.post("./Modules/Frozen_Dough_Management/apps/itemlist_form.php", { params: params },
	function(data) {		
...
$(function()
{
	$('#search').keyup(function()
	{
		...
		$.post("./Modules/Frozen_Dough_Management/includes/itemlist_data.php", { limit: limit, search: search, category: category },
		function(data) {
			$('#smnavdata').html(data);
		});
...
function load_data()
{
	...
	$.post("./Modules/Frozen_Dough_Management/includes/itemlist_data.php", { limit: limit },
	function(data) {
		$('#smnavdata').html(data);
		rms_reloaderOff();
	});
