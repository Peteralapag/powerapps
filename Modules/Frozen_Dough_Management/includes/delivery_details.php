...
<div style="padding:10px">
	...
	<?php
		$sqlQuery = "SELECT * FROM fds_branch_order WHERE control_no='$control_no' AND cancelled=0";
...
function printDR(controlno)
{
	...
	$.post("./Modules/Frozen_Dough_Management/includes/printable_dr.php", { control_no: controlno },
	function(data) {		
...
function requestReopenYes(controlno)
{
	...
	if(delivery_date == 0)
	{
		...
		$.post("./Modules/Frozen_Dough_Management/actions/actions.php", { mode: mode, control_no: controlno, recipient: recipient },
		function(data) {		
	...
	else if(delivery_date == 1)
	{
		...
		var recipient = $('#recipient').val();
		$.post("./Modules/Frozen_Dough_Management/actions/actions.php", { mode: mode, year: year, month: month, day: day, control_no: controlno, recipient: recipient },
		function(data) {		
			$('#setintransitresults').html(data);
		});	
	}
...
function setInTransit(controlno)
{
	...
	if(delivery_date == 0)
	{
		...
		setTimeout(function()
		{
			$.post("./Modules/Frozen_Dough_Management/actions/actions.php", { mode: mode, control_no: controlno },
			function(data) {		
				$('#setintransitresults').html(data);
				rms_reloaderOff();
			});
...
function logisticInfo(controlno)
{
	...
	$.post("./Modules/Frozen_Dough_Management/apps/logistic_info.php", { control_no: controlno },
	function(data) {		
