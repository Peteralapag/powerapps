...
';
	$page = '';
	$sqlPageCnt = "SELECT * FROM fds_branch_order WHERE control_no='$control_no' AND cancelled=0";
...
';
		$sqlQuery = "SELECT * FROM fds_branch_order WHERE control_no='$control_no' AND cancelled=0 LIMIT $startFrom, $itemsPerDiv";
