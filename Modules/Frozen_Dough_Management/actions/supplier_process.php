...
if($mode == 'add')
{
	$query = "SELECT * FROM fds_supplier WHERE name='$name'";
    ...
    if ( $checkRes->num_rows === 0 ) 
    {
		...
		$queryInsert = "INSERT INTO fds_supplier ($column)";
...
if($mode == 'edit') {
	...
	$queryDataUpdate = "UPDATE fds_supplier SET $update WHERE id='$rowid'";
