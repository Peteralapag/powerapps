...
$created_by = $_SESSION['fds_appnameuser'];
...
if($_POST['mode'] == 'new')
{
	...
	$queryInsert = "INSERT INTO fds_warehouse_transfer ($column)";
...
if($_POST['mode'] == 'update')
{
	...
	";
	$queryDataUpdate = "UPDATE fds_warehouse_transfer SET $update WHERE id='$rowid'";
