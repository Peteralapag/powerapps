...
{
	$rowid = $_POST['rowid'];	
	$delQuery = "SELECT * FROM fds_warehouse_transfer WHERE id='$rowid'";
...
/*			
			$queryDataUpdate = "UPDATE fds_inventory_stock SET stock_in_hand='$total_undo' WHERE item_code='$item_code'";
...
{
	$queryDataDelete = "DELETE FROM fds_warehouse_transfer WHERE id='$rowid'";
