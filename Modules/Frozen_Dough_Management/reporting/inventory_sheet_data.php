...
$_SESSION['FDS_YEARS'] = $_POST['theyears'];
$_SESSION['FDS_MONTHS'] = $_POST['themonths'];
$_SESSION['FDS_DAYS'] = $_POST['thedays'];
...
<?php
	$maxLength = 20;	
	$queryItems = "SELECT * FROM fds_itemlist WHERE category='RAWMATS' AND active=1";
...
$(function()
{
	$('.expdatevalue').dblclick(function()
	{
		...
		$.post("./Modules/Frozen_Dough_Management/reporting/expdate_form.php", { itemcode: itemcode, expdate: expdate, trans_date: trans_date, elemid: rem_id },
		function(data) {		
	...
	$('.remvalue').dblclick(function()
	{
		...
		$.post("./Modules/Frozen_Dough_Management/reporting/remarks_form.php", { itemcode: itemcode, remarks: remarks, trans_date: trans_date, elemid: rem_id },
		function(data) {		
			$('#formodalsm_page').html(data);
			$('#formodalsm').show();
		});
	...
	$('.trvalue').dblclick(function()
	{
		...
		$.post("./Modules/Frozen_Dough_Management/reporting/phycount_form.php", { itemcode: itemcode, phycount: phycount, trans_date: trans_date, elemid: button_id },
		function(data) {		
			$('#formodalsm_page').html(data);
			$('#formodalsm').show();
		});
