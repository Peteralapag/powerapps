...
function removedColumn()
{
	...
	$.post("./Modules/Frozen_Dough_Management/reporting/fds_report_data.php", { limit: limit, columns: chkcolumns },
	function(data) {		
		$('#tableData').html(data);
	});  
}
...
{
	var limit = $('#limit').val();
	$.post("./Modules/Frozen_Dough_Management/reporting/fds_report_data.php", { limit: limit, columns: columns },
	function(data) {
		$('#tableData').html(data);
	});
}
