...
{
	$rowid = $_POST['rowid'];
	$QUERY = "SELECT * FROM fds_receiving WHERE receiving_id='$rowid'";
	...
	<table style="width: 100%" class="table lamesako">
		<tr>
			...
			<td>
				...
				<input id="supplier" type="text" class="form-control" value="FROZEN DOUGH RECEPTION AREA" disabled>
			</td>		
		</tr>
		<tr>
...
*/	
	...
	setTimeout(function()
	{
		$.post("./Modules/Frozen_Dough_Management/actions/receiving_process.php", 
		{  
			mode: mode,
			rowid: rowid, 
			limit: limit, 
