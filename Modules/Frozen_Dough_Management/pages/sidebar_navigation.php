...
if(isset($_SESSION['fds_userlevel']))
{
...
<?php
$sqlMenu = "SELECT * FROM fds_navigation WHERE active=1 ORDER BY ordering ASC";
...
function fdsSettings()
{
	...
	if(user_level => 80)
	{
		$.post("./Modules/Frozen_Dough_Management/pages/fds_settings.php", { },
		function(data) {
			$('#contents').html(data);
		});
	} else {
...
{
	$.post("./Modules/Frozen_Dough_Management/pages/menu_pages.php", { page: page },
	function(data) {
		$('#contents').html(data);
	});
}
...
{
	$.post("./Modules/Frozen_Dough_Management/actions/close_applications.php", { },
	function(data) {
		$('#contents').html(data);
	});
}
