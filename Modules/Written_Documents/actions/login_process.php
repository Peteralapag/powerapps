...
if($mode=='c10cc6b684e1417e8ffa924de1e58373')
{
	...
	$pass = $_POST['password'];
	$user_app = "Written Documents (Archiving)";
    ...
    { 
		...
		if($void == 0)
		{
			$_SESSION['wd_username'] = $username;
			$_SESSION['wd_company'] = $company;
			$_SESSION['wd_appnameuser'] = $employee;
			$_SESSION['wd_userlevel'] = $user_level;
			$_SESSION['wd_userrole'] = $user_role;
			$_SESSION['wd_application'] = $user_app;		
			$cmd = '';
			$cmd .='				
				<script>
					$("#formmodal").hide();
