...
if($mode=='c10cc6b684e1417e8ffa924de1e58373')
{
	...
	$pass = $_POST['password'];
	$user_app = "FD Branch Ordering System";
    ...
    { 
		...
		{
			mysqli_close($db);
			$_SESSION['fds_branch_username'] = $username;
			$_SESSION['fds_branch_company'] = $company;
			$_SESSION['fds_branch_branch'] = $branch;
			$_SESSION['fds_branch_appnameuser'] = $employee;
			$_SESSION['fds_branch_userlevel'] = $user_level;
			$_SESSION['fds_branch_userrole'] = $user_role;
			$_SESSION['fds_branch_application'] = $user_app;
			$_SESSION['fds_branch_cluster'] = $cluster;
			$cmd = '';
			$cmd .='				
				<script>
					$("#formmodal").hide();
